...
class TestExceptionHandling(unittest.TestCase):
    def test_zero_content_length(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 400, URL: . Error: The request is missing or has a bad parameter.")
    ...
    def test_401_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "Invalid GitHub Personal Access Token (PAT). The token was rejected by GitHub.")
        finally:
    ...
    def test_403_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 403, URL: . Error: User doesn't have permission to access the resource.")
    ...
    def test_404_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 404, URL: . Error: The resource you have specified cannot be found. Please refer '{}' for more details.".format(json.get("documentation_url")))
    ...
    def test_301_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 301, URL: . Error: The resource you are looking for is moved to another URL.")
    ...
    def test_304_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 304, URL: . Error: The requested resource has not been modified since the last time you accessed it.")
    ...
    def test_422_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 422, URL: . Error: The request was not able to process right now.")
    ...
    def test_409_error(self, mocked_request):
        ...
        try:
            ...
            self.assertEquals(str(e), "HTTP-error-code: 409, URL: . Error: The request could not be completed due to a conflict with the current state of the server.")
